...
class TestCollectorLatency(unittest.TestCase):
    ...
    def test_latency_with_missing_timestamps(self):
        ...
        usages = [
            TokenUsage(input_tokens=100, output_tokens=50, timestamp="2025-11-07T10:00:00"),
            TokenUsage(input_tokens=100, output_tokens=50, timestamp=None),
            TokenUsage(input_tokens=100, output_tokens=50, timestamp="2025-11-07T10:00:02"),
        ]
    ...
    def test_latency_persists_across_batches(self):
        ...
        batch2 = [
            TokenUsage(input_tokens=100, output_tokens=50, timestamp="2025-11-07T10:00:01"),
        ]
    ...
    def test_collect_from_log_file_with_timestamps(self):
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.log', delete=False) as f:
            ...
            f.write('2025-11-07T10:00:00 {"usage": {"input_tokens": 100, "output_tokens": 50}}\n')
            f.write('2025-11-07T10:00:01 {"usage": {"input_tokens": 100, "output_tokens": 50}}\n')
            f.write('2025-11-07T10:00:02 {"usage": {"input_tokens": 100, "output_tokens": 50}}\n')
    ...
    def test_latency_calculation_uses_parser_method(self):
        ...
        with patch.object(self.collector.parser, 'calculate_latency', wraps=self.collector.parser.calculate_latency) as mock_calc:
            self.collector._write_batch(100, usages, 'claude-sonnet-4')
