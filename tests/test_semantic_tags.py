...
class TestMatchTypeDetection:
    ...
    def test_test_function(self):
        ...
        assert (
            detect_match_type("def test_something():", "tests/test_main.py") == "test"
        )
...
class TestGrepFormatting:
    ...
    def test_function_definition_format(self):
        ...
        result = format_grep_result("src/main.py", 42, "def process_data():", Path("."))
    ...
    def test_import_statement_format(self):
        ...
        result = format_grep_result("utils.py", 1, "import os", Path("."))
    ...
    def test_test_function_format(self):
        ...
        result = format_grep_result(
            "tests/test_main.py", 91, "def test_process_data():", Path(".")
        )
...
class TestTokenOverhead:
    ...
    def test_grep_tags_overhead(self):
        ...
        baseline = "\n".join(
            f"{file}:{line}: {content}" for file, line, content in results
        )
        baseline_tokens = count_tokens(baseline)
...
class TestIntegration:
    ...
    def test_end_to_end_ls(self, tmp_path):
        ...
        # Format all entries
        entries = [format_ls_entry(entry, tmp_path) for entry in tmp_path.iterdir()]
