    ...
    def test_delegation_with_additional_flags(self):
        ...
        with patch('subprocess.run') as mock_run:
            ...
            delegate_to_claude_code(
                task="Test task",
                additional_flags="--model claude-sonnet-4 --verbose"
            )
...
class TestDelegateToClaudeCodeAsync:
    ...
    def test_async_delegation_returns_task_id(self):
        ...
        with patch('subprocess.Popen') as mock_popen:
            ...
            assert 'running in background' in result.lower() or 'started' in result.lower()
...
class TestOutputTruncation:
    ...
    def test_truncate_output_small_output(self):
        ...
        truncated, was_truncated, stats = _truncate_output(small_output, max_tokens=20000)
    ...
    def test_truncate_output_large_output(self):
        ...
        truncated, was_truncated, stats = _truncate_output(large_output, max_tokens=1000)
...
class TestPhaseInfoReading:
    ...
    def test_read_phase_info_success(self):
        ...
        with patch('builtins.open', mock_open(read_data='{"phase": "build", "progress": 50}')):
    ...
    def test_read_phase_info_stale_file(self):
        ...
        with patch('pathlib.Path.exists') as mock_exists:
            with patch('pathlib.Path.stat') as mock_stat:
                ...
                mock_stat.return_value.st_mtime = (task_start - timedelta(minutes=5)).timestamp()
