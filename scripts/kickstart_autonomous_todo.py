...
This will test the full autonomous workflow."""
    ...
    print("🎯 Working Directory: /Users/name/homelab/context-foundry")
    print("🔧 Mode: fix_bugs (enhancing existing project)")
    print("✅ Test Loop: Enabled (max 2 iterations)")
    print("⏱️  Timeout: 90 minutes")
    print()
