...
# ruff: noqa: E402
"""
[DEPRECATED] Bootstrap Roblox Patterns into Global Pattern Storage
...
def bootstrap_roblox_patterns():
    """Bootstrap Roblox patterns into global pattern files"""
    ...
    for pattern in data.get("patterns", []):
        ...
        global_pattern = {
            ...
            "category": "roblox",
            "project_types": pattern.get("applies_to", ["roblox-agentflow"]),
    ...
    for issue in data.get("common_issues", []):
        ...
        global_issue = {
            ...
            "category": "roblox",
            "project_types": ["roblox-agentflow"],
            "tech_stack": ["roblox"],
...
if __name__ == "__main__":
    ...
    if "--force-merge" not in sys.argv:
        ...
        print("  - Cross-contamination (Roblox patterns in Python builds)")
        ...
        print("  python scripts/bootstrap_roblox_patterns.py --force-merge")
        print("=" * 70)
        sys.exit(1)
