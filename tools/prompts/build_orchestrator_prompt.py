...
def build_orchestrator_prompt(
    ...
    for phase_file in phase_files:
        ...
        if include_flowise and FLOWISE_AVAILABLE:
            ...
            if flowise_enhancement:
                ...
                phases_content.append("\n")
                phases_content.append(f"FLOWISE EXTENSION - {phase_name.upper()} ENHANCEMENTS\n")
                phases_content.append("═" * 63)
                phases_content.append("\n\n")
    ...
    print(f"   Flowise enhancements: {'Included' if include_flowise and FLOWISE_AVAILABLE else 'Not included'}")
...
def main():
    ...
    if args.dry_run:
        ...
        prompt = build_orchestrator_prompt(include_flowise=include_flowise, output_path="/tmp/dry_run_orchestrator.txt")
        print(f"\n✅ Dry run complete - no files modified")
    else:
        prompt = build_orchestrator_prompt(
            include_flowise=include_flowise,
