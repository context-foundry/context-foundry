...
class LocalClaudeProvider(LLMProvider):
    ...
    def generate(
        ...
        cmd = [
            ...
            "--strict-mcp-config",
            "--print",
            "--tools", "default",  # Enable all tools in print mode
        ...
        try:
            if event_callback:
                ...
                if process.returncode != 0:
                    ...
                    raise RuntimeError(f"Claude CLI execution failed (code {process.returncode}): {stderr}")
...
class BedrockProvider(LLMProvider):
    ...
    def __init__(self, region_name: str = "us-east-1", tool_executor: Optional[Callable[[str, Dict], Any]] = None, default_model: Optional[str] = None):
    ...
    def generate(
        ...
        model_id = model or self.default_model or "anthropic.claude-opus-4-5-20251101-v1:0"
            ...
            try:
                ...
                if stop_reason == "tool_use":
                    if not self.tool_executor:
                        raise RuntimeError("Model requested tool use but no tool_executor provided")
                    ...
                    for res in tool_results:
                        ...
                        tool_result_content.append({
                            ...
                            "content": res["content"], # This is [{"json": ...}] or [{"text": ...}]
        ...
        try:
            ...
            for event in response.get("completion"):
                ...
                # 3. Handle Return Control (Tool Execution)
                    ...
                    if not self.tool_executor:
                        raise RuntimeError("Agent requested tool execution (Return Control) but no tool_executor provided.")
