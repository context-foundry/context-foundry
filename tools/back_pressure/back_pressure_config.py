...
LANGUAGE_PROFILES = {
    ...
    "typescript": {
        ...
        "checks": {
            "syntax": {"enabled": True, "command": "npx tsc --noEmit", "timeout": 30},
            "type": {"enabled": True, "command": "npx tsc --noEmit", "timeout": 30},
            "lint": {
                "enabled": True,
    ...
    "rust": {
        ...
        "checks": {
            "syntax": {"enabled": True, "command": "cargo check", "timeout": 60},
            "type": {
    ...
    "go": {
        ...
        "checks": {
            "syntax": {"enabled": True, "command": "go build", "timeout": 30},
            "type": {
                "enabled": False,  # Included in go build
            },
            "lint": {"enabled": True, "command": "go vet", "timeout": 20},
            "format": {"enabled": True, "command": "gofmt -l .", "timeout": 10},
            "imports": {
    ...
    "ruby": {
        ...
        "checks": {
            "syntax": {"enabled": True, "command": "ruby -c {file}", "timeout": 10},
            "lint": {
                "enabled": True,
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        print("\nAvailable commands:")
        print(
            "  python back_pressure_config.py <dir>           - Show config for directory"
        )
        print(
            "  python back_pressure_config.py list            - List all language profiles"
        )
        sys.exit(1)
